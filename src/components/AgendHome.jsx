...
export function AgendHome() {
  return (
    <section className='flex md:flex-row flex-col justify-between items-center gap-7 py-10 px-4 md:px-8'>
...
function CardAgend({ title, primary, secondary }) {
  return (
    <section className='bg-white md:w-auto w-full py-6 px-4 md:px-10 rounded-lg'>
      ...
      <section className='flex gap-3 mt-4'>
        <div className='flex flex-col gap-2'>
          ...
          <button className='flex w-[95px] sm:w-[110px] justify-between p-0'>
            <span className='text-[10px] md:text-xs text-gray-400'>Select your city</span>
            <ArrowRight />
          </button>
        </div>
        <div className='flex flex-col gap-2 border-x border-gray-200 px-2 md:px-5'>
          <h3 className='font-bold text-sm'>Date</h3>
          <button className='flex w-[95px] sm:w-[110px] justify-between'>
            <span className='text-[10px] md:text-xs text-gray-400'>Select your date</span>
            <ArrowRight />
          </button>
        </div>
        <div className='flex flex-col gap-2'>
          ...
          <button className='flex w-[95px] sm:w-[110px] justify-between'>
            <span className='text-[10px] md:text-xs text-gray-400'>Select your time</span>
            <ArrowRight />
          </button>
        </div>
      </section>
